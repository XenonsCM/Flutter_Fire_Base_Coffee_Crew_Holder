      ...
      appBar: AppBar(
        ...
        actions: [
          ElevatedButton.icon(
            ...
            label: Text("Register"),
            style: ElevatedButton.styleFrom(primary: Colors.brown[400],elevation: 0.0),
          )
        ],
      ),
      body: Container(
          ...
          child: Form(
            ...
            child: Column(
              children: [
                ...
                TextFormField(validator:(val)=>val!.length<6 ? "Enter a password 6+ chars long":null,
                ...
                ElevatedButton(
                  ...
                  onPressed: () async {
                      ...
                      if (result == null){
                        setState(() { 
                          err = "Could not sıgn in with those credentials";
                          loading = false;
                          });
                      }
                    }
